...
:: Android packaging
set AND_CERT_NAME="BuildShip"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\BuildShip.p12
...
set IOS_PROVISION=cert\BuildShip.mobileprovision
...
set APP_ID=air.BuildShip

:: Output packages
set DIST_PATH=dist
set DIST_NAME=BuildShip
