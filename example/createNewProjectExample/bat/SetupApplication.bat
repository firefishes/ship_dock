...
:: Android packaging
set AND_CERT_NAME="createNewProject"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\createNewProject.p12
...
set IOS_PROVISION=cert\createNewProject.mobileprovision
...
set APP_ID=air.createNewProject

:: Output packages
set DIST_PATH=dist
set DIST_NAME=createNewProject
