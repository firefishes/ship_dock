...
:: Android packaging
set AND_CERT_NAME="viewExample"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\viewExample.p12
...
set IOS_PROVISION=cert\viewExample.mobileprovision
...
set APP_ID=air.viewExample

:: Output packages
set DIST_PATH=dist
set DIST_NAME=viewExample
